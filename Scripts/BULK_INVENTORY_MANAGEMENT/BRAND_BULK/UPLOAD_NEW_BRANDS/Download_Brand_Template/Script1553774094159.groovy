...
WebUI.click(findTestObject('Page_GitoMe Digital Transformation Platform/a_Download Brand Template'))

WebUI.delay(10)

System.out.println('Brand Template is Downloaded Successfully')
