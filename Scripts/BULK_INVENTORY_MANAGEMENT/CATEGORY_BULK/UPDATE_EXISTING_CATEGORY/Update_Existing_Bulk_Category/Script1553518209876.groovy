...
WebUI.click(findTestObject('Object Repository/Page_GitoMe Digital Transformation Platform/a_Update existing Categories'))

WebUI.sendKeys(findTestObject('UPLOAD_CAT/Upoad_Existing_Cat'), 'C:\\Users\\User\\Desktop\\Category\\Category Download.xls')

WebUI.delay(3)

WebUI.click(findTestObject('UPLOAD_CAT/UploadCategory'))
